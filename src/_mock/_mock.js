...
const _mock = {
  ...
  image: {
    cover: (index) =>
      `https://cognito-idp.us-east-2.amazonaws.com/assets/images/covers/cover_${index + 1}.jpg`,
    product: (index) =>
      `https://cognito-idp.us-east-2.amazonaws.com/assets/images/products/product_${index + 1}.jpg`,
    avatar: (index) =>
      `https://cognito-idp.us-east-2.amazonaws.com/assets/images/avatars/avatar_${index + 1}.jpg`,
  },
};
